...
btn_eq = tk.Button(root,text="=",command= evaluate_calcluation,width=5,font=("Arial",14))
...
btn_c = tk.Button(root,text="c",command=clear_field,width=5,font=("Arial",14))
